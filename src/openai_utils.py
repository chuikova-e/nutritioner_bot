...
async def analyze_image_with_gpt(photos_base64: list, additional_info: str) -> str:
    ...
    # Prepare base prompt
    prompt = f"Определи КБЖУ блюда по {'фотографии' if photos_base64 else 'описанию'}. " \
...
async def analyze_weight_progress(username: str, current_weight: float, food_records: list, weight_history, target_weight, nutrition_goals) -> str:
